...
def inputdata():  # 輸入資料
    ...
    driver.find_element_by_xpath("//tr[5]/td[4]").click()  # 10月31日
...
if login_sucess == True:
    ...
    driver.find_element_by_id("mobilePhone").send_keys("0982163003")  # 行動電話
    driver.find_element_by_id("name2622").send_keys("c7934597@gmail.com")  # mail
